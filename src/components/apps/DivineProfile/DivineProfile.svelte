...
<section class="container">
	...
	<aside class:light={preferences.theme.scheme === 'light'}>
		<nav>
			<a href="https://www.divineadeyeye.dev/blog" use:external> <BlogIcon /> Blog </a>
			<a href="https://www.divineadeyeye.dev/works" use:external> <WorksIcon /> Works </a>

			<hr />

			<a href="https://www.divineadeyeye.dev/twitter" use:external>
				<TwitterIcon />
				Twitter
			</a>
			<a href="https://www.divineadeyeye.dev/github" use:external> <GithubIcon /> Github </a>
			<a href="https://www.divineadeyeye.dev/devto" use:external> <DevToIcon /> Dev.to </a>
		</nav>
	</aside>

	<section class="content">
		<img height="200" width="200" src="/divine-profile/profile.png" alt="Divine Adeyeye Profile pic" />

		<br />

		<h1>Hi, I'm Divine Adeyeye</h1>

		<h2>
			Ẹ káàbọ̀ sí ojú opó wẹ́bù wa.(yoruba) 
