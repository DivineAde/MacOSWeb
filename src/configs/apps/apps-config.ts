...
const divineProfile = create_app_config({
...
const viewSource = create_app_config({
	...
	should_open_window: false,
	external_action: () => window.open('https://github.com/DivineAdeyeye/macos-web', '_blank'),
});
...
const vercel = create_app_config({
	...
	should_open_window: false,
	external_action: () =>
		window.open('https://vercel.com/?utm_source=divine-projects&utm_campaign=oss', '_blank'),
